...
public class Ex1Main {
    public static void main(String[] args) {
        ...
        while (!num1.equals(quit) && !num2.equals(quit))
        {
            ...
            System.out.printf("num2= %s is number: true , value: %d ", num2 , num2Base10);
